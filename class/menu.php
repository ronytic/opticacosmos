...
class menu extends bd{
	...
	function mostrar($Nivel,$Posicion=""){
		...
		switch($Nivel){
			...
			case "5":{return $this->getRecords(" Vendedor=1 and Activo=1 $Posicion","Orden");}break;
		}
	}
	function verificar($Directorio,$Nivel){
		switch($Nivel){
			...
			case "5":{return $this->getRecords("Url='$Directorio' and  Vendedor=1 and Activo=1","Orden");}break;
		}
	}
}
?>
...
<!-- Mirrored from 198.74.61.72/themes/preview/ace/ by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 02 Feb 2014 17:40:21 GMT -->
<head>
		<meta charset="utf-8" />
		...
		<!--[if IE 7]>
		  <link rel="stylesheet" href="css/core/font-awesome-ie7.min.css" />
		<![endif]-->
		...
		<link rel="stylesheet" href="css/core/ace-fonts.css" />

		<!-- ace styles -->

		<link rel="stylesheet" href="css/core/ace.min.css" />
		<link rel="stylesheet" href="css/core/ace-rtl.min.css" />
		<link rel="stylesheet" href="css/core/ace-skins.min.css" />

		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="css/core/ace-ie.min.css" />
		<![endif]-->
		...
		<script src="js/core/ace-extra.min.js"></script>
	...
	the lightweight, feature-rich and easy to use admin template.
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='js/core/framework/jquery-2.0.3.min.js'>"+"<"+"/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='js/core/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->

		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='js/core/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
		<script src="js/core/framework/bootstrap.min.js"></script>
		<script src="js/core/typeahead-bs2.min.js"></script>
		...
		<script src="js/core/ace-elements.min.js"></script>

		<script src="js/core/ace.min.js"></script>
...
<!-- Mirrored from 198.74.61.72/themes/preview/ace/ by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 02 Feb 2014 17:40:52 GMT -->
</html>
